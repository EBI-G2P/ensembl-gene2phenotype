...
ALTER TABLE genomic_feature_disease_log_deleted ADD FOREIGN KEY (genomic_feature_disease_id) REFERENCES genomic_feature_disease(genomic_feature_disease_id);
ALTER TABLE genomic_feature_disease_log_deleted ADD FOREIGN KEY (genomic_feature_id) REFERENCES genomic_feature(genomic_feature_id);
ALTER TABLE genomic_feature_disease_log_deleted ADD FOREIGN KEY (disease_id) REFERENCES disease(disease_id);
